<script>
    $(document).ready(function() {
        ...
        $('#purchaseUpdateForm').on('submit', function(e) {
            ...
            const updateUrl = "{{ route('admin.sale.return.update', ':id') }}".replace(':id', purchaseId);
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.status === 'success') {
                        showSuccessToast(res.message || 'Sale Return updated successfully.');
                        setTimeout(() => {
                            window.location.href =
                                "{{ route('admin.sale-item.return') }}";
                        }, 1500);
                    } else {
